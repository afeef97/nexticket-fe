...
import { getComplaintTickets } from './actions';
...
export default function Complaint() {
  ...
  const {
    data: complaintTicketData,
    state: getComplaintTicketsState,
    triggerQuery: triggerGetComplaintTickets,
  } = useQueryHandler({
    query: () =>
      getComplaintTickets({
        page: currentPage,
              ...
              <div className='inline-block min-w-full py-2 align-middle md:px-6 lg:px-8'>
                <table className='min-w-full '>
                  ...
                  <tbody className='divide-y divide-lineSecondary'>
                    {/* loading state */}
                    {getComplaintTicketsState === 'pending' && (
                      <tr>
                    ...
                    {/* normal state */}
                    {getComplaintTicketsState === 'resolved' &&
                    ...
                    {/* error state */}
                    {(getComplaintTicketsState === 'resolved' ||
                      getComplaintTicketsState === 'error') &&
                      ((complaintTicketData.ok &&
